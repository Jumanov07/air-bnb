...
import { updateUserData } from '../../redux/slices/profilePageSlice';
import SelectLabel from '../announcment/SelectLabel';
...
function Edit() {
   const {
      ...
      location,
      images: imagesById,
   } = useSelector((state) => state.profileData.userData);
         ...
         <StyledBoxImageContainer>
            <StyledBoxImage>
               {images?.map((item, index) => {
                  return (
                     <StyledPhotoBox key={item}>
                        <StyledPhoto src={item} alt="" />
